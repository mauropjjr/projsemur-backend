...
public class GetProjetoResponse
{
    ...
    public virtual GetAssuntoRequest? AssuntoaltNavigation { get; set; }

    public virtual Atividade.Get.GetResponse? AtividadeNavigation { get; set; }

    public virtual Codificacao.Get.GetResponse? CodificacaoNavigation { get; set; }

    public virtual GetAnalistaRequest? FiscalNavigation { get; set; }

    public virtual GetNaturezaRequest? NaturezaNavigation { get; set; }
