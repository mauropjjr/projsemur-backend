...
public class Projeto : BaseEntity
{
    ...
    /// <summary>
    /// forminputlabel[Data Homologacao]
    /// forminputsize[30]
    /// forminputclass[datetime]
    /// 
    /// geragridmain[false]
    ...
    public virtual Assunto1? AssuntoNavigation { get; set; }

    public virtual Assunto1? AssuntoaltNavigation { get; set; }

    public virtual Atividade? AtividadeNavigation { get; set; }

    public virtual Codificacao? CodificacaoNavigation { get; set; }

    public virtual Analistum? FiscalNavigation { get; set; }

    public virtual ICollection<Historico> Historicos { get; set; } = new List<Historico>();

    public virtual Natureza? NaturezaNavigation { get; set; }

    public virtual Prfage? ProfissionalNavigation { get; set; }

    public virtual Regiao? RegiaoNavigation { get; set; }

    public virtual ICollection<Remessa> Remessas { get; set; } = new List<Remessa>();

    public virtual Zoneamento? ZoneamentoNavigation { get; set; }
}
